...
extension Breed {
  static var mock: Breed {
    Breed(
      ...
      popularity: 17,
      photoUrl: URL(string: "https://raceconditionsoftware.s3.us-west-1.amazonaws.com/CatFancy/img/CloudedLeopard.jpg")!,
  ...
  static var mock: [Breed] {
    [
      ...
      Breed(
        ...
        knownFor: "warm coat",
        popularity: 19,
        photoUrl: URL(string: "https://raceconditionsoftware.s3.us-west-1.amazonaws.com/CatFancy/img/EuropeanWildcat.jpg")!,
      ...
      Breed(
        ...
        knownFor: "sad face",
        popularity: 21,
        photoUrl: URL(string: "https://raceconditionsoftware.s3.us-west-1.amazonaws.com/CatFancy/img/Sand.jpg")!,
      ...
      Breed(
        ...
        popularity: 39,
        photoUrl: URL(string: "https://raceconditionsoftware.s3.us-west-1.amazonaws.com/CatFancy/img/Serval.jpg")!,
      ...
      Breed(
        ...
        popularity: 22,
        photoUrl: URL(string: "https://raceconditionsoftware.s3.us-west-1.amazonaws.com/CatFancy/img/Smilodon.jpg")!,
